...
V4L2Wrapper::V4L2Wrapper(const string& device, int width, int height) : 
                        device(device),
                        xres(width),
                        yres(height)
{
...
void V4L2Wrapper::open_device(void)
{
      struct stat st;
...
void V4L2Wrapper::init_mmap(void)
{
...
void V4L2Wrapper::close_device(void)
{
      if (-1 == close(fd))
...
void V4L2Wrapper::init_device(void)
{
    ...
    if (force_format) {
        ...
        if (fmt.fmt.pix.pixelformat != V4L2_PIX_FMT_YUYV)
            ...
            throw runtime_error("V4L2Wrapper does not support YUYV format. Support for more format need to be added!");
...
void V4L2Wrapper::uninit_device(void)
{
    unsigned int i;
...
void V4L2Wrapper::start_capturing(void)
{
    unsigned int i;
...
void V4L2Wrapper::stop_capturing(void)
{
    enum v4l2_buf_type type;
